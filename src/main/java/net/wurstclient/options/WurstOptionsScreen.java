...
public class WurstOptionsScreen extends Screen
{
	...
	private void addLinkButtons()
	{
		...
		new WurstOptionsButton(54, 96, () -> "Murst",
				"§d§lMurst 版本信息\n"
					+ "§e版本: §fMurst v" + WurstClient.VERSION
					+ "§e适用版本: §fMinecraft 1.20.4\n"
					+ "§e发布时间: §f2025-1-2 14:00\n"
					+ "§e基带: §fWurst v7.46.1-MC1.20.4\n",
			b -> {});
		
		new WurstOptionsButton(54, 120, () -> "Murst Github", "Click To Open Murst's Github",
			b -> os.open("https://github.com/xiaomu18/Murst"));
	}
	...
	private void renderTitles(DrawContext context)
	{
		...
		context.drawCenteredTextWithShadow(tr, "Murst Options", middleX, y1,
			0xffffff);
